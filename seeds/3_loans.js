  ...
  return knex('loans').del()
    .then(function () {
      ...
      return knex('loans').insert([
        ...
        {loan_id: 2017, lenders_id: 7007,  borrowers_id: 7005, item_id: 12005, pickup: '2017-04-25 14:12:22', dropoff: '2017-04-30 10:00:00'},
        ...
        {loan_id: 2024, lenders_id: 7014,  borrowers_id: 7004, item_id: 12012, pickup: '2017-04-25 14:12:22', dropoff: '2017-04-30 10:00:00'},
      ]);
    });
};
